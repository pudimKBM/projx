...
try:
    ...
    data_valid = {
        "quote": {"insurance_holder": {"birth_date": " Lorem ipsum dolor sit amet"}},
        "contract": {
            "insurance_holder": {
                "addresses": [
                    {
                ...
                "phones": [
                    {
                        "number": " Lorem ipsum dolor sit amet",
                        "area_code": " Lorem ipsum dolor sit amet",
                    },
                    {
                        "number": " Lorem ipsum dolor sit amet",
                        "area_code": " Lorem ipsum dolor sit amet",
    ...
    var = validate(instance={"name": "Eggs", "price": 34.99}, schema=json_str)
    ...
    print(jsonschema.validate(valid_data, valid_datax))
    try:
        print(validate(instance=[2, 3, 4], schema={"maxItems": 4}))
